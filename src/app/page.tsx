      ...
      <section className={styles.hero} aria-labelledby="dashboard-heading">
        ...
        <div className={styles.heroMain}>
          ...
          <motion.div className={styles.heroMap} initial={false} animate={{ opacity: heroVisible || reducedMotion ? 1 : 0, y: heroVisible || reducedMotion ? 0 : 35 }} transition={{ duration: reducedMotion ? 0 : 1.4, ease: EASE }}>
            <div className={styles.mapFloat} style={{ animationPlayState: ambientPaused || reducedMotion || !pageVisible ? "paused" : "running" }}><Image src="/dashboard/thailand.svg?v=3" alt="แผนที่ประเทศไทย" width={340} height={570} sizes="(max-width: 760px) 100vw, 64vw" loading="eager" fetchPriority="high" unoptimized /></div>
          </motion.div>
