...
import { LiveEmployeeCount } from "./components/LiveEmployeeCount";
      ...
      <section className={styles.hero} aria-labelledby="dashboard-heading">
        ...
        <div className={styles.heroMain}>
          <motion.div className={styles.heroCopy} {...reveal} transition={{ duration: 0.9, delay: reducedMotion ? 0 : 0.45, ease: EASE }}>
            ...
            <h2>Employee<br /><LiveEmployeeCount key={user?.staffId || user?.username || "guest"} allowed={canPage("dashboard") && Boolean(user?.permissions.view)} reducedMotion={reducedMotion || ambientPaused || !pageVisible} /></h2>
