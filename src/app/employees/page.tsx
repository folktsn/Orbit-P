  ...
  return (
    <div className="p-8 max-w-5xl mx-auto space-y-8">
      ...
      <div className="flex justify-center">
        <div className="flex bg-white dark:bg-[#121212] p-1.5 rounded-full shadow-sm border border-slate-100 dark:border-white/5">
          <button
        ...
        <div className="md:col-span-1 relative">
          ...
          {isDatePickerOpen && (
            <>
              ...
              <div className="absolute top-full left-0 mt-2 w-72 bg-white dark:bg-[#1a1a1a] border border-slate-200 dark:border-white/10 rounded-2xl shadow-xl z-50 p-4 space-y-3">
